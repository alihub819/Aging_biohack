  ...
  const milestones = [
    {
      year: "2010",
      title: "Clinic Founded",
      description: "Established with a vision to explore innovative wellness strategies through regenerative medicine research."
    },
    {
      year: "2015",
      title: "Research Partnership",
      description: "Collaborated with leading medical institutions to advance research in investigational therapies."
    },
    {
      year: "2018",
      title: "Recognition for Innovation",
      description: "Acknowledged for advancements in wellness-focused regenerative medicine approaches."
    },
    {
      year: "2020",
      title: "Expansion",
      description: "Opened a state-of-the-art wellness facility in Miami, focused on investigational therapies."
    }
  ];
    ...
    <Layout>
      <div className="relative bg-teal-700 py-16 sm:py-24">
        ...
        <div className="relative max-w-7xl mx-auto py-24 px-4 sm:px-6 lg:px-8">
          <h1 className="text-4xl font-extrabold tracking-tight text-white sm:text-5xl lg:text-6xl">About Aging Biohacks</h1>
          <p className="mt-6 max-w-3xl text-xl text-teal-100">
            Pioneering the future of wellness through innovative, investigational approaches to regenerative medicine and personalized care.
          </p>
        </div>
      </div>
      ...
      <div className="bg-white py-16 sm:py-24">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="lg:text-center">
            <h2 className="text-3xl font-extrabold text-gray-900 sm:text-4xl">Our Mission</h2>
            <p className="mt-4 max-w-2xl text-xl text-gray-500 lg:mx-auto">
              To explore research-driven wellness strategies that support the body’s natural regenerative abilities and enhance overall well-being.
            </p>
          </div>
          ...
          <div className="mt-16 grid grid-cols-1 gap-8 sm:grid-cols-2 lg:grid-cols-3">
            {[
              {
                icon: Heart,
                title: "Patient-Centered Wellness",
                description: "Personalized care plans designed to support each individual’s unique wellness goals."
              },
              {
                icon: Microscope,
                title: "Advanced Research",
                description: "Continuous investment in investigational therapies and scientific innovation."
              },
              {
                icon: GraduationCap,
                title: "Expert Team",
                description: "Highly qualified professionals dedicated to safe, ethical wellness exploration."
              }
            ].map((feature) => (
              <div key={feature.title} className="pt-6">
                <div className="flow-root bg-gray-50 rounded-lg px-6 pb-8">
      ...
      <div className="bg-teal-700">
        <div className="max-w-7xl mx-auto py-12 px-4 sm:px-6 lg:py-24 lg:px-8 lg:flex lg:justify-between">
          <h2 className="text-3xl font-extrabold text-white md:text-4xl">
            Ready to explore wellness solutions?
            <span className="block text-teal-200">Schedule a consultation today.</span>
          </h2>
          <a
            href="https://meet.brevo.com/medicalwellness/aging-biohacking-appointments-"
